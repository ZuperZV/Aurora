...
public class AlcheFlameScreen extends AbstractContainerScreen<AlcheFlameMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(aurora.MOD_ID, "textures/gui/alche_flame_gui.png");

    public AlcheFlameScreen(AlcheFlameMenu container, Inventory inventory, Component title) {
