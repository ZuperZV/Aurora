...
public class ArcanePowerTableMenu extends AbstractContainerMenu {
    private final BlockPos pos;
    private final ArcanePowerTableBlockEntity blockentity;
    public ArcanePowerTableMenu(int containerId, Player player, BlockPos pos) {
        super(ModMenuTypes.ARCANE_POWER_TABLE_MENU.get(), containerId);
        ArcanePowerTableBlockEntity ArcanePowerTableBlockEntity;
        this.pos = pos;

        if (player.level().getBlockEntity(pos) instanceof ArcanePowerTableBlockEntity blockentity) {
            ArcanePowerTableBlockEntity = blockentity;
            ...
            ArcanePowerTableBlockEntity = null;
        ...
        this.blockentity = ArcanePowerTableBlockEntity;
    }

    @Override
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(blockentity.getLevel(), blockentity.getBlockPos()), player, ModBlocks.ARCANE_POWER_TABLE.get());
    }
