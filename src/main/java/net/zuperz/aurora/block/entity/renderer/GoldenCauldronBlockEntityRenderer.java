...
public class GoldenCauldronBlockEntityRenderer implements BlockEntityRenderer<GoldenCauldronBlockEntity> {

    public GoldenCauldronBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
    }

    @Override
    public void render(GoldenCauldronBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
