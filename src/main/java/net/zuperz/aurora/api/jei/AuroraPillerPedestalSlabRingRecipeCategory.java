...
public class AuroraPillerPedestalSlabRingRecipeCategory implements IRecipeCategory<AuroraPillerPedestalSlabRingRecipe> {
    public final static ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(aurora.MOD_ID, "aurora_piller_pedestal_slab_ring");
    public static final RecipeType<AuroraPillerPedestalSlabRingRecipe> RECIPE_TYPE = RecipeType.create(aurora.MOD_ID, "aurora_piller_pedestal_slab_ring", AuroraPillerPedestalSlabRingRecipe.class);
    ...
    @Override
    public RecipeType<AuroraPillerPedestalSlabRingRecipe> getRecipeType() {
        return JEIPlugin.AURORA_PILLER_PEDESTAL_SLAB_RING_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.literal("Aurora Piller Pedestal Slab Ring 5x5");
    }
    ...
    @Override
    public void draw(AuroraPillerPedestalSlabRingRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX,
                     double mouseY) {
    ...
    @Override
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, AuroraPillerPedestalSlabRingRecipe recipe, @NotNull IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.INPUT, 18, 34)
