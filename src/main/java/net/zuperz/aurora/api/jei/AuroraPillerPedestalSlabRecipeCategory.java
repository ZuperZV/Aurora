...
public class AuroraPillerPedestalSlabRecipeCategory implements IRecipeCategory<AuroraPillerPedestalSlabRecipe> {
    public final static ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(aurora.MOD_ID, "aurora_piller_pedestal_slab");
    public static final RecipeType<AuroraPillerPedestalSlabRecipe> RECIPE_TYPE = RecipeType.create(aurora.MOD_ID, "aurora_piller_pedestal_slab", AuroraPillerPedestalSlabRecipe.class);
    ...
    public AuroraPillerPedestalSlabRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public RecipeType<AuroraPillerPedestalSlabRecipe> getRecipeType() {
        return JEIPlugin.AURORA_PILLER_PEDESTAL_SLAB_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.literal("Aurora Piller Pedestal Slab 5x5");
    }
    ...
    @Override
    public void draw(AuroraPillerPedestalSlabRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX,
                     double mouseY) {
    ...
    @Override
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, AuroraPillerPedestalSlabRecipe recipe, @NotNull IFocusGroup focuses) {
