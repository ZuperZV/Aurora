...
public class AuroraAlterRecipe implements Recipe<RecipeInput> {
    ...
    public AuroraAlterRecipe(ItemStack output, Ingredient ingredient0, Ingredient ingredient1, Ingredient ingredient2, Ingredient ingredient3, Ingredient ingredient4) {
        this.output = output;
    ...
    public RecipeSerializer<?> getSerializer() {
        return AuroraAlterRecipe.Serializer.INSTANCE;
    }

    @Override
    public RecipeType<?> getType() {
        return AuroraAlterRecipe.Type.INSTANCE;
    }

    public static final class Type implements RecipeType<AuroraAlterRecipe> {
        private Type() { }
        public static final Type INSTANCE = new Type();
        public static final String ID = "aurora_aurora_alter";
    }

    public static final class Serializer implements RecipeSerializer<AuroraAlterRecipe> {
        private Serializer() {}
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID =
                ResourceLocation.fromNamespaceAndPath(aurora.MOD_ID, "aurora_alter");

        private final MapCodec<AuroraAlterRecipe> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
            ...
            ).apply(instance, AuroraAlterRecipe::new);
        });

        private final StreamCodec<RegistryFriendlyByteBuf, AuroraAlterRecipe> STREAM_CODEC = StreamCodec.of(
                Serializer::write, Serializer::read);

        @Override
        public MapCodec<AuroraAlterRecipe> codec() {
            return CODEC;
        }

        @Override
        public StreamCodec<RegistryFriendlyByteBuf, AuroraAlterRecipe> streamCodec() {
            return STREAM_CODEC;
        }

        private static AuroraAlterRecipe read(RegistryFriendlyByteBuf buffer) {
            ...
            return new AuroraAlterRecipe(output, input0, input1, input2, input3, input4);
        }

        private static void write(RegistryFriendlyByteBuf buffer, AuroraAlterRecipe recipe) {
